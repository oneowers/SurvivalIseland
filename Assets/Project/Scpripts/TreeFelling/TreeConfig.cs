...
namespace ProjectResonance.TreeFelling
{
    ...
    /// <summary>
    /// Requests damage application to a specific tree.
    /// </summary>
    public readonly struct ChopEvent
    {
        ...
        public ChopEvent(ChoppableTree tree, Vector3 hitDirection, int damage)
        {
            Tree = tree;
        ...
        /// <summary>
        /// Gets the target tree.
        /// </summary>
        public ChoppableTree Tree { get; }
    ...
    /// <summary>
    /// Broadcasts a successful hit on a choppable tree.
    /// </summary>
    public readonly struct TreeHitEvent
    {
        ...
        public TreeHitEvent(ChoppableTree tree, int hitsRemaining)
        {
            Tree = tree;
    ...
    /// <summary>
    /// Requests the fall sequence for a specific tree.
    /// </summary>
    public readonly struct TreeFallStartEvent
    {
        ...
        /// </summary>
        /// <param name="tree">Tree that should start falling.</param>
        public TreeFallStartEvent(ChoppableTree tree)
        {
            Tree = tree;
        }

        /// <summary>
        /// Gets the tree that should start falling.
        /// </summary>
        public ChoppableTree Tree { get; }
    }
